...
char ssid[] = "NETGEAR97";                                     //your network SSID (name)
char password[] = "sweetgiant762";                                   //your network key

// Initialize Telegram BOT
#define BOTtoken "938699593:AAFu-1jBajNM-vB6wRbdFK0NDw8KxHzV8EI"      //Bot Token
#define BOTname "HouseBoT"
#define BOTusername "peac_house_bot"
